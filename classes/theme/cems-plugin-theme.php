...
class CEMSPluginTheme extends WPDKWordPressTheme{
    ...
    public function wp_enqueue_scripts()
    {
        ...
        wp_enqueue_script( 'wpcems-bootstrapvalidator', '//cdnjs.cloudflare.com/ajax/libs/jquery.bootstrapvalidator/0.5.2/js/bootstrapValidator.min.js', array( 'wpcems-bootstrap' ), false, true );
        wp_enqueue_script( 'wpcems-chosen', '//cdnjs.cloudflare.com/ajax/libs/chosen/1.1.0/chosen.jquery.min.js', array( 'jquery' ), false, true );
        wp_enqueue_script( 'wpcems-ebooksubscription', WPCEMS_URL_JAVASCRIPT . 'customer_source.min.js', array( 'jquery' ), false, true );
        wp_enqueue_script( 'wpcems-ebooksubscription', WPCEMS_URL_JAVASCRIPT . 'cems-event17.min.js', array( 'wpcems-bootstrapvalidator','wpcems-chosen' ), false, true );
        ...
        wp_enqueue_style( 'wpcems-bootstrap-chosen', '//cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.3.0/css/datepicker.min.css', array(),false);
        wp_enqueue_style( 'wpcems-bootstrap-chosen', '//cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.3.0/css/datepicker3.min.css', array(),false);
