 ...
 * Author URI: http://siliconstraits.vn
...
if ( !class_exists( 'CEMSPlugin' ) ) {
	...
	final class CEMSPlugin extends WPDKWordPressPlugin {
		...
		public function __construct( $file ) {
			...
			// Register shortcode
			add_action( 'wp_loaded', array( 'CEMSSubscriberListShortcode', 'init' ) );
			// Register alertbox on wp_footer
			add_action( 'wp_footer', array( $this, 'wp_cems_kit_alert_box' ) );
		...
		private function registerClasses() {
			...
			$includes = array(
				...
				$this->classesPath . 'ajax/cems-subscription-ajax-handler.php' => 'CEMSSubscriptionAjaxHandler',
				//$this->classesPath . 'core/cems-preview-ebook.php' => 'CEMSPreviewEbook',
				//$this->classesPath . 'core/cems-subscriber-list-content.php' => 'CEMSSubscriberListContent',
				...
				$this->classesPath . 'subscriber-list/cems-subscriber-list.php' => array(
					'CEMSSubscriberList',
					'CEMSCreateSubscriberFormBranch' ),
				$this->classesPath . 'subscriber-list/cems-subscriber-list-viewcontroller.php' => array(
					'CEMSSubscriberListViewController',
					'CEMSSubscriberTableView',
					'CEMSCreateSubscriberView' ),
				...
				$this->classesPath . 'shortcodes/cems-subscriber-list-shortcode.php' => 'CEMSSubscriberListShortcode',
				$this->classesPath . 'theme/cems-plugin-theme.php' => 'CEMSPluginTheme',
				$this->classesPath . 'databases/cems-database.php' => 'CEMSDatabase',
			);
		...
		public function activation() {
			...
			CEMSSubscriberList::init()->delta();
			// Create or update database
			CEMSDatabase::init_database();
		}
		...
		public function ajax() {
			// For example
			CEMSSubscriptionAjaxHandler::init();
		}
		
		
		/**
		* Add alert box to footer
		*/
		public function wp_cems_kit_alert_box(){
				WPDKHTML::startCompress();
			?>
			<div class="wp-cems-kit">
				<div id="wp-cems-kit-alert-box" class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="wp-cems-kit-alert-box-title" aria-hidden="true">
				  <div class="modal-dialog">
				    <div class="modal-content">
				      <div class="modal-header">
				        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				        <h4 class="modal-title" id="wp-cems-kit-alert-box-title">Thông báo</h4>
				      </div>
